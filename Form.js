...
this.button14.mousePressed(()=>{
    ...
    this.button15.mousePressed(()=>{
        ...
        this.result1 = createButton("RESULTS");
        this.result1.position(450,250);

        this.result1.mousePressed(()=>{
            this.end1.hide();
            this.result1.hide();
          
        this.bag1 = createElement("h2","AGE- 8 to 10");
        this.prob1i1 = createElement("h2","girls of this age are");
        this.prob1i2 = createElement("h2","mainly facing discrimination");
        this.prob1i3 = createElement("h2","from their siblings.");
         
         this.bag1.position(300,330);
         this.prob1i1.position(300,360);
         this.prob1i2.position(300,380);
         this.prob1i3.position(300,400);
    
        this.bag2 = createElement("h2","AGE- 11 to 14");
        this.prob2i1 = createElement("h2","girls of this age are");
        this.prob2i2 = createElement("h2","mainly facing problems");
        this.prob2i3 = createElement("h2","with studies.");

        this.bag2.position(700,330);
        this.prob2i1.position(700,360);
        this.prob2i2.position(700,380);
        this.prob2i3.position(700,400);

        this.bag3 = createElement("h2","AGE- 15 to 16");
        this.prob3i1 = createElement("h2","girls of this age are");
        this.prob3i2 = createElement("h2","mainly facing deppresion");
        this.prob3i3 = createElement("h2","due to neglegence");

        this.bag3.position(1000,330);
        this.prob3i1.position(1000,360);
        this.prob3i2.position(1000,380);
        this.prob3i3.position(1000,400);


        this.phsyco1 = createRadio();
        this.phsyco1.option("If You are feeling depressed then select")
         this.phsyco1.position(300,500)
        this.phsyco1.mousePressed(()=>{
            
      this.final = createElement("h2","you can contact- 1234567890")
            this.final.position(360,550)
        })
        })
